...
const TIPTAP_REQUIREMENTS = [
  ...
  ["Tiptap table selected cell resize continuity", ".mn-tiptap-table-cell.mn-tiptap-table-cell-selected > .column-resize-handle", "width: 16px"],
...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap slash command icon system", ".mn-tiptap-command-icon-svg", "width: 14.5px"],
