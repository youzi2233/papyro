...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap table menu panel popover", ".tiptap-table-menu-content .tiptap-combobox-list", "min-width: 15rem"],
  ["Tiptap table menu item rhythm", ".tiptap-table-menu-content .tiptap-button", "justify-content: flex-start"],
