...
const PREVIEW_REQUIREMENTS = [
  ...
  ["preview table scroll container", ".mn-preview-table-scroll", "overflow-x: auto"],
  ["preview table keeps native layout", ".mn-preview table", "display: table"],
...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap Papyro portal menu root token scope", ":root,\n.mn-tiptap-react-root,\n.mn-tiptap-editor", "--mn-tiptap-menu-z"],
  ["Tiptap Papyro menu radius token", ".mn-tiptap-react-root", "--mn-tiptap-menu-radius:var(--mn-radius-md"],
  ["Tiptap Papyro Radix dropdown layer", ".tiptap-dropdown-menu-content", "--mn-tiptap-menu-z"],
  ["Tiptap Papyro Radix dropdown surface", ".tiptap-dropdown-menu-content", "--tt-dropdown-menu-bg-color"],
  ["Tiptap Papyro Radix dropdown data-slot surface", "[data-slot=\"tiptap-dropdown-menu-content\"]", "--tt-dropdown-menu-bg-color"],
  ["Tiptap Papyro Radix submenu surface", ".tiptap-dropdown-menu-sub-content", "min-width: min(13rem"],
  ["Tiptap Papyro Radix submenu data-slot surface", "[data-slot=\"tiptap-dropdown-menu-sub-content\"]", "min-width: min(13rem"],
  ["Tiptap Papyro Radix dropdown group vertical", ".tiptap-dropdown-menu-content .tiptap-dropdown-menu-group", "flex-direction: column"],
  ["Tiptap Papyro Radix dropdown data-slot group vertical", "[data-slot=\"tiptap-dropdown-menu-content\"] [data-slot=\"tiptap-dropdown-menu-group\"]", "flex-direction: column"],
  ["Tiptap Papyro Radix submenu group vertical", ".tiptap-dropdown-menu-sub-content .tiptap-dropdown-menu-group", "gap: 0.125rem"],
  ["Tiptap Papyro Radix dropdown box sizing", ".tiptap-dropdown-menu-content", "box-sizing: border-box"],
  ["Tiptap Papyro Radix dropdown item rhythm", ".tiptap-dropdown-menu-content .tiptap-button", "--mn-tiptap-menu-item-height"],
  ["Tiptap Papyro Radix dropdown data-slot item rhythm", "[data-slot=\"tiptap-dropdown-menu-content\"] [data-slot=\"tiptap-button\"]", "--mn-tiptap-menu-item-height"],
  ["Tiptap Papyro Radix dropdown hover", ".tiptap-dropdown-menu-content .tiptap-dropdown-menu-item[data-highlighted]", "--mn-tiptap-menu-hover-bg"],
  ["Tiptap Papyro Radix dropdown label", ".tiptap-dropdown-menu-label", "font-size: 0.6875rem"],
  ...
  ["Tiptap Papyro selection floating layer", ".tiptap-selection-floating-layer", "--mn-tiptap-menu-z"],
  ["Tiptap Papyro selection floating layer max content", ".tiptap-selection-floating-layer", "min-width: max-content"],
  ["Tiptap Papyro selection toolbar inline row", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"]", "display: inline-flex"],
  ["Tiptap Papyro selection toolbar no wrap", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"]", "flex-flow: row nowrap"],
  ["Tiptap Papyro selection toolbar text no wrap", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"]", "white-space: nowrap"],
  ["Tiptap Papyro selection toolbar groups fixed row", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"] > .tiptap-toolbar-group", "flex: 0 0 auto"],
  ["Tiptap Papyro selection toolbar buttons fixed row", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"] .tiptap-button", "flex: 0 0 auto"],
  ["Tiptap Papyro selection toolbar icon normalization", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"] .tiptap-button-icon", "min-width: 1rem"],
  ["Tiptap Papyro selection toolbar swatch normalization", ".tiptap-selection-toolbar.tiptap-toolbar[data-variant=\"floating\"] .tiptap-button-color-text-popover", "max-height: 1rem"],
  ...
  ["Tiptap Papyro tooltip enterprise width", ".tiptap-tooltip", "max-width: min(18rem"],
  ...
  ["Tiptap table cell menu hidden legacy icon", ".expandable-menu-button svg", "opacity: 0"],
  ["Tiptap table cell menu refined dot glyph", ".expandable-menu-button::after", "radial-gradient(currentColor"],
  ...
  ["Tiptap Papyro table cell handle restrained icon", ".expandable-menu-button", "--icon-scale-large: 0"],
  ["Tiptap Papyro table cell handle anchored inset", ".expandable-menu-button", "--cell-handle-inset"],
  ["Tiptap Papyro table cell handle refined shell", ".expandable-menu-button::before", "--tt-table-cell-handle-bg-color"],
  ["Tiptap Papyro table cell handle shell centered", ".expandable-menu-button::before", "translate(-50%, -50%)"],
  ["Tiptap Papyro table cell handle glyph centered", ".expandable-menu-button::after", "translate(-50%, -50%)"],
  ...
  ["Tiptap table menu opaque root", ".tiptap-menu-content.tiptap-table-menu-content", "var(--tt-combobox-bg-color"],
  ["Tiptap table menu root shadow", ".tiptap-menu-content.tiptap-table-menu-content", "var(--tt-shadow-elevated-md"],
  ["Tiptap table menu direct panel", ".tiptap-table-menu-content > .tiptap-combobox-list", "margin-block: 0"],
  ["Tiptap table menu transparent direct panel", ".tiptap-table-menu-content > .tiptap-combobox-list", "background: transparent"],
  ["Tiptap table menu direct panel has no duplicate shadow", ".tiptap-table-menu-content > .tiptap-combobox-list", "box-shadow: none"],
  ...
  ["Tiptap code language menu usable height", ".mn-tiptap-code-language-menu", "min-height: min(232px"],
  ["Tiptap code language inline menu viewport height", ".mn-tiptap-code-language-menu-inline", "calc(100vh - 20px"],
  ["Tiptap code language list scroll containment", ".mn-tiptap-code-language-menu-list", "overscroll-behavior: contain"],
