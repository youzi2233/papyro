...
const TIPTAP_REQUIREMENTS = [
  ...
  ["Tiptap table context menu top layer", ".mn-tiptap-table-toolbar", "z-index: 170"],
  ["Tiptap table selection object border", ".mn-tiptap-table-selection-outline", "border: 2px solid var(--mn-accent)"],
  ["Tiptap table selection mist", ".mn-tiptap-table-selection-backdrop", "color-mix(in srgb, var(--mn-accent) 7%, transparent)"],
  ["Tiptap table single cell object border", ".mn-tiptap-table-selection-outline[data-selection-kind=\"cell\"]", "border-width: 2.5px"],
  ...
  ["Tiptap table hovered column line", ".mn-tiptap-table-axis-hover-backdrop[data-axis=\"column\"]", "inset -2px 0 0"],
  ["Tiptap table hovered row line", ".mn-tiptap-table-axis-hover-backdrop[data-axis=\"row\"]", "inset 0 -2px 0"],
...
const TIPTAP_COMMAND_PANEL_REQUIREMENTS = [
  ...
  ["Tiptap table style submenu trigger", ".mn-tiptap-table-toolbar-submenu-trigger", "grid-template-columns: 20px minmax(0, 1fr) 10px"],
  ["Tiptap table style submenu panel", ".mn-tiptap-table-toolbar-submenu-panel", "left: calc(100% + 8px)"],
  ["Tiptap table style submenu hover", ".mn-tiptap-table-toolbar-submenu-group:hover > .mn-tiptap-table-toolbar-submenu-panel", "pointer-events: auto"],
  ...
  ["Tiptap table row handle span", ".mn-tiptap-table-axis-handle.row", "min-width: 20px"],
  ["Tiptap table column handle span", ".mn-tiptap-table-axis-handle.column", "min-height: 20px"],
  ["Tiptap table handle stacking", ".mn-tiptap-table-axis-handle", "z-index: 167"],
  ["Tiptap table handle pointer reachability", ".mn-tiptap-table-axis-handle", "pointer-events: auto"],
  ["Tiptap table chrome buttons receive pointers", ".mn-tiptap-table-chrome-root button", "pointer-events: auto"],
