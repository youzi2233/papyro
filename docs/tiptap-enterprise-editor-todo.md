...
- [ ] Make the entire cell surface editable and focusable, not only a tiny center area.
  - Current coverage: blank cell surfaces and empty paragraph surfaces now commit a single-cell selection, while filled inline content keeps native ProseMirror text selection and does not start table-range dragging.
